  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <button onClick={logout} style={{ backgroundColor: '#dc2626', color: 'white', padding: '10px 20px', borderRadius: '6px', fontWeight: 'bold', border: 'none' }}>Logout</button>
      </header>
      ...
      <div style={{ padding: '2rem' }}>
        ...
        {showForm && (
          <div style={{
            ...
            <div style={{
              ...
              <form onSubmit={addEmployee}>
                <input placeholder="Employee ID" value={empId} onChange={(e) => setEmpId(e.target.value)} required className={styles.input} /><br /><br />
                <input placeholder="Name" value={name} onChange={(e) => setName(e.target.value)} required className={styles.input} /><br /><br />
                <input placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} required className={styles.input} /><br /><br />
        ...
        <h3 style={{ color: '#facc15' }}>Attendance Records</h3>
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', backgroundColor: '#2e2a27', color: '#fff3e6', borderCollapse: 'collapse' }}>
            <thead>
            ...
            <tbody>
              {data.map((a, i) => (
                <tr key={i} style={{ borderTop: '1px solid #444' }}>
                  ...
                  <td style={{ padding: '8px', border: '1px solid #444' }}>{a.timeDiff || ''}</td>
                </tr>
              ))}
            </tbody>
          </table>
