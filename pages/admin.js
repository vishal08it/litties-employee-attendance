...
//                 setShowForm(false);
//               }}>
//                 <input value={empId} onChange={(e) => setEmpId(e.target.value)} placeholder="Employee ID" required className={styles.input} /><br />
//                 <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Name" required className={styles.input} /><br />
//                 <input value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" required className={styles.input} /><br />
...
//               <DatePicker selected={dateFrom} onChange={(date) => setDateFrom(date)} placeholderText="From" className={styles.input} /><br />
//               <DatePicker selected={dateTo} onChange={(date) => setDateTo(date)} placeholderText="To" className={styles.input} /><br />
